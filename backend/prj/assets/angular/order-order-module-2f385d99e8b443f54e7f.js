...
let ListComponent = class ListComponent {
    constructor(apiService, loginService) {
        ...
        this.userId = 0;
        this.orders = [];
        this.displayedColumns = ['position', 'name', 'amount', 'price', 'price_multiple', 'category', 'subcategory', 'user_rating'];
        this.rating = 0;
...
//# sourceMappingURL=order-order-module-2f385d99e8b443f54e7f.js.map