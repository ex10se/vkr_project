...
const routes = [
    ...
    { path: ':popular', component: _list_list_component__WEBPACK_IMPORTED_MODULE_3__["ListComponent"] },
...
let ListComponent = class ListComponent {
    constructor(http, apiService, route, basketService, router, scroll, loginService) {
        ...
        this.apiService.getPredictions().subscribe((res) => {
    ...
    doGetPopularProductList(limit, offset) {
        this.apiService.getPopularProductList(limit, offset).subscribe((res) => {
            this.products = res.results;
            for (const product of this.products) {
                product.amount = 1;
            }
    ...
    doSearch(query, limit, offset) {
        if (query) {
            this.apiService.doSearchProduct(query, limit, offset).subscribe((res) => {
                this.products = res.results;
                for (const product of this.products) {
                    product.amount = 1;
                }
                    ...
                    providers: [
                        {
                            ...
                            provider: new angularx_social_login__WEBPACK_IMPORTED_MODULE_25__["GoogleLoginProvider"]('639913863818-8braj8bdl2g5c7oblsabdn84j5qr3jo9.apps.googleusercontent.com')
                        }
                    ]
                },
            }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("mat-paginator {\n  background-color: transparent;\n  font-size: initial;\n}\n\n.dummy-product-card {\n  background-color: #f5f5f5;\n}\n\n.dummy-popular-product-card {\n  background-color: #f3f3f3;\n}\n\n.dummy-product-card, .product-card {\n  min-height: 310px;\n}\n\n.dummy-popular-product-card, .popular-product-card {\n  min-height: 100px;\n}\n\n.popular-product-card {\n  background-color: #fdfcff;\n}\n\nmat-card {\n  margin-top: 10px;\n  border: 1px solid transparent;\n}\n\nmat-card-title, mat-card-subtitle {\n  width: 185px;\n}\n\nmat-card-title {\n  font-size: 14px !important;\n  padding-bottom: 10px;\n  margin: 0 !important;\n  min-height: 50px;\n}\n\nmat-card-subtitle, .mat-cart-subtitle {\n  text-align: right;\n}\n\n.category-title, .subcategory-title, .common-rating {\n  margin: 0 !important;\n}\n\n.category-title button, .subcategory-title button {\n  padding: 0;\n}\n\n.common-rating {\n  padding-top: 5px;\n}\n\nmat-card-subtitle > button {\n  font-size: 12px;\n  line-height: 0;\n}\n\nmat-card:hover {\n  border: 1px solid #bdc7ff;\n}\n\nmat-card:hover mat-card-title {\n  white-space: normal;\n}\n\n#title-text {\n  font-size: 30px;\n}\n\n.description {\n  width: 120px;\n  text-align: end;\n  font-size: 12px;\n}\n\n.description span {\n  display: block;\n}\n\n.category-image {\n  width: 50px;\n  text-align: center;\n  margin-right: 16px;\n}\n\n.cat-img {\n  object-fit: cover;\n  width: 100%;\n  height: 100%;\n}\n\n.mat-card-image {\n  height: 100%;\n  width: 100px;\n  object-fit: contain;\n  margin: 0 !important;\n  cursor: pointer;\n}\n\n.mat-card-content {\n  margin: 0 !important;\n  height: 110px;\n}\n\nmat-card-actions {\n  margin: 0 !important;\n  display: flex;\n  place-content: space-around;\n}\n\nbutton.mat-stroked-button.price {\n  color: #8e8181;\n  border: none;\n}\n\n.plus-minus-group {\n  height: 48px;\n}\n\n.plus-minus {\n  height: 24px;\n}\n\n.count {\n  color: #8e8181;\n}\n\n.to-basket {\n  margin: 0 !important;\n}\n\n.search-box {\n  width: 20%;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let ApiService = class ApiService {
    ...
    doSearchProduct(query, limit, offset) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].backendUrl}v1/market/product_list?searchkey=${query}` +
            `&limit=${limit}&offset=${offset}`);
    }
    getPopularProductList(limit, offset) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].backendUrl}v1/market/popular_products?limit=${limit}&offset=${offset}`);
    }
    getCategoryList() {
    ...
    setProductRating(user, product, rating) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].backendUrl}v1/market/user_rating_list`, { user, product, rating });
    }
    getBasketInfo(pars) {
    ...
    changeUserProfile(user, firstName, phone, address) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].backendUrl}v1/market/user_profile`, { user, firstName, phone, address });
    }
    submitBasket(data) {
    ...
    getPredictions() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].backendUrl}v1/market/predictions`);
    }
};
...
//# sourceMappingURL=main-2f385d99e8b443f54e7f.js.map