...
/* harmony import */ var _list_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./list/list.component */ "dSEE");
...
/***/ "Y9Xp":
/*!**************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/order/list/list.component.html ***!
  \**************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".order-info {\n  color: #3f51b5;\n  background-color: #f3f3fd;\n  font-size: inherit;\n}\n\n.footer-total {\n  background-color: #f8f8fb;\n  font-weight: bold;\n}\n\ntr.mat-footer-row, tr.mat-header-row {\n  height: 40px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "dSEE":
/*!**********************************************!*\
  !*** ./src/app/order/list/list.component.ts ***!
  \**********************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_list_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./list.component.html */ "Y9Xp");
/* harmony import */ var _list_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list.component.scss */ "abE4");
...
let ListComponent = class ListComponent {
    constructor(apiService, loginService) {
        ...
        this.userId = 0;
        this.orders = [];
        this.displayedColumns = ['position', 'name', 'amount', 'price', 'price_multiple', 'category', 'subcategory'];
        this.loginService.isAuth$.subscribe((res) => {
            this.isAuth = res;
            if (this.isAuth) {
                this.apiService.init().subscribe((data) => {
                    this.userId = data.user.id;
                    this.apiService.getOrderList(this.userId).subscribe((rez) => {
                        this.orders = rez;
                        this.orders.sort((a, b) => b.updated_at.localeCompare(a.updated_at));
                        this.loading = false;
                    });
                });
            }
...
//# sourceMappingURL=order-order-module-56ae854cc5e903efebe4.js.map